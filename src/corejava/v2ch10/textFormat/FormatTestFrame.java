...
/**
 * Фрейм с целым рядом полей ввода форматируемого текста и
 * кнопкой для отображения значений в этих полях
 */
public class FormatTestFrame extends JFrame {
    ...
    /**
     * Вводит ряд полей на основной панели
     * @param labelText Метка поля
     * @param field Образцовое поле
     */
            ...
            if (cl.isArray()) {
                if (cl.getComponentType().isPrimitive()) {
                    try {
                        ...
                        // игнорировать ожидаемые результаты рефлексии
                    }
