...
/**
 * Этот фрейм содержит комбинированный список лдя выбора правил,
 * композиции, ползунок для изменения прозрачности в альфа-канале
 * исходного изображения, а также компонент для отображения
 * результатов составления изображений
 */
public class CompositeTestFrame extends JFrame {
    ...
    public CompositeTestFrame() {
        ...
        ruleCombo = new JComboBox<>(new Rule[] { new Rule("CLEAR", "  ", "  "),
                ...
                new Rule("SRC_IN", "  ", " D"), new Rule("SRC_OUT", " S", "  "),
